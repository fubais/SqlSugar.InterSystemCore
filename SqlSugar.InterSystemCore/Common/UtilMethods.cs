...
namespace SqlSugar.InterSystemCore
{
    ...
    {
        internal static DateTime GetMinDate() => new DateTime(1901,1,1);

        internal static DateTime GetMinDate(ConnectionConfig config) => new DateTime(1901, 1, 1);
        ...
        internal static string ReplaceSqlParameter(string itemSql, SugarParameter itemParameter, string newName)
        {
